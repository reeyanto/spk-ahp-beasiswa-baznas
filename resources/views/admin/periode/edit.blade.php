                ...
                <div class="card-body">
                    <form action="{{ route('periode.update', $periode->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" placeholder="Masukkan Nama Priode" value="{{ old('nama', $periode->nama) }}" />
                            @error('nama')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" rows="3" placeholder="Tambahkan Keterangan" style="resize:none">{{ old('keterangan', $periode->keterangan) }}</textarea>
                            @error('keterangan')
                                <span class="text text-danger">{{ $message }}</span>
                            @enderror
                        </div>
